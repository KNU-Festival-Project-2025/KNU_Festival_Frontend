...
*/}
  ...
  return (
    <div
      className="w-full max-w-[430px] h-screen overflow-x-hidden overflow-y-scroll snap-y snap-mandatory bg-contain bg-center bg-no-repeat -mt-16"
      style={{
    ...
    >
      <div
        ref={scroll1Ref}
        className="w-full h-screen flex flex-col items-center overflow-hidden bg-[url('/assets/home/BGimg/BackImg1.webp')] bg-cover bg-center snap-start"
      >
        <div
          className={`text-center mt-[95px] transition-all duration-1000 ${isVisible.logo
        ...
        {/* 1번째 HomeCard */}
        <div
          className={`mt-[30px] w-full h-auto px-4 transition-all duration-1000 ${isVisible.cards
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-8"
            }`}
        >
        ...
        <div
          className={`h-[63px] mt-[60px] text-centertransition-all duration-300 ${isVisible.button
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-8"
            }`}
        >
      ...
      <div
        ref={scroll3Ref}
        className="w-full h-screen-hybrid min-h-[600px] pt-[90px] 
             bg-cover bg-center bg-no-repeat 
             bg-[url('/assets/home/BGimg/BackImg4.webp')] 
             overflow-hidden snap-start"
      >
        <div
          ref={card60thRef}
          className={`transition-all duration-1000 ${homeCard2Visibility["homecard2-card60th"]
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-8"
            }`}
        >
        ...
        <div
          ref={cardFutureRef}
          className={`transition-all duration-1000 ${homeCard2Visibility["homecard2-cardFuture"]
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-8"
            }`}
        >
      ...
      <div
        className="w-full h-screen-hybrid min-h-[600px] pt-[64px] 
             bg-cover bg-center bg-no-repeat 
             bg-[url('/assets/home/BGimg/BackImg5.webp')] 
             overflow-hidden snap-start"
      >
        <div
          ref={cardStadiumRef}
          className={`transition-all duration-1000 ${homeCard2Visibility["homecard2-cardStadium"]
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-8"
            }`}
        >
        ...
        <div
          ref={cardHaminRef}
          className={`transition-all duration-1000 ${homeCard2Visibility["homecard2-cardHamin"]
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-8"
            }`}
        >
      ...
      <div
        ...
        className="w-full h-screen flex flex-col items-center overflow-hidden bg-[url('/assets/home/BGimg/BackImg1.webp')] bg-cover bg-center snap-start"
      >
        <div className="mt-60 flex flex-col w-[343.699px] h-[364px]">
          <div
            ref={designerRef}
            className={`transition-all duration-1000 ${developerVisibility.designer
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
              }`}
          >
          ...
          <div
            className={`transition-all duration-1000 ${developerVisibility.frontend
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
              }`}
          >
          ...
          <div
            className={`transition-all duration-1000 ${developerVisibility.backend
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
              }`}
          >
